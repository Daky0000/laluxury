...
/**
 * The all-products grid, filters and all.
 *
 * It lives in a component rather than in the page so the storefront's front
 * door can render it too — the owner chooses at /admin/settings which page `/`
 * serves. Its forms and links always point at /shop, so filtering from the
 * front page carries on at the catalog's own address.
 */
export async function ProductCatalog({ params }: { params: CatalogParams }) {
